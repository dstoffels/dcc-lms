...
class Pace(models.Model):
    ...
    flex_factor = models.FloatField(default=1.0)  # Flex allotment as percentage of hours per week
...
class Cohort(models.Model):
    ...
    track = models.ForeignKey(Track, on_delete=models.PROTECT, related_name="cohorts")
